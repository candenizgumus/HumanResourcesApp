...
public interface OfferRepository extends JpaRepository<Offer, Long>
{
    ...
    @Query("select new com.humanresourcesapp.views.VwGetAllOffer(o.id,o.name,o.surname,o.email,o.phone,o.companyName,o.title,o.numberOfEmployee,o.userType,o.approvalText) from Offer o  where o.status = 'PENDING' AND o.email like %?1%")
