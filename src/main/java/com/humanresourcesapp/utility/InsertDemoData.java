...
public class InsertDemoData
{
    ...
    private void insertDefinitionDemoData(){
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.LEAVE_TYPE).name("HALF_ANNUAL").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.LEAVE_TYPE).name("FAMILY_CARE").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.LEAVE_TYPE).name("JURY_DUTY").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.EMPLOYEE_TYPE).name("FULL_TIME").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.EMPLOYEE_TYPE).name("PART_TIME").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("ADMINISTRATIVE_ASSISTANT").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("ADVERTISING_MANAGER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("AEROSPACE_ENGINEER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("AGRICULTURAL_ENGINEER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("AIR_TRAFFIC_CONTROLLER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("ART_DIRECTOR").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("BANK_TELLER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("BIOMEDICAL_ENGINEER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("BROADCAST_ENGINEER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("BUSINESS_ANALYST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CAD_TECHNICIAN").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CHEMICAL_ENGINEER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CIVIL_ENGINEER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CLAIMS_ADJUSTER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CLINICAL_LAB_TECHNICIAN").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("COMPUTER_ENGINEER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("COMPUTER_PROGRAMMER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("COMPUTER_SUPPORT_SPECIALIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CONSTRUCTION_MANAGER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CREDIT_ANALYST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("CUSTOMER_SERVICE_REPRESENTATIVE").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("DATA_ANALYST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("DATABASE_ADMINISTRATOR").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("DENTAL_ASSISTANT").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("ELECTRICAL_ENGINEER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("ELEMENTARY_SCHOOL_TEACHER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("ENVIRONMENTAL_ENGINEER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("EVENT_PLANNER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("EXECUTIVE_ASSISTANT").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("FINANCIAL_ADVISOR").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("FINANCIAL_ANALYST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("FLIGHT_ATTENDANT").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("FORENSIC_SCIENTIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("GRAPHIC_DESIGNER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("HEALTH_EDUCATOR").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("HOSPITAL_ADMINISTRATOR").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("HOTEL_MANAGER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("HUMAN_RESOURCES_SPECIALIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("HVAC_TECHNICIAN").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("INDUSTRIAL_ENGINEER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("INFORMATION_SECURITY_ANALYST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("INSURANCE_AGENT").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("INTERIOR_DESIGNER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("IT_MANAGER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("LANDSCAPE_ARCHITECT").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("LOGISTICS_MANAGER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MANAGEMENT_ANALYST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MARKETING_MANAGER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MARKET_RESEARCH_ANALYST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MECHANICAL_ENGINEER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MEDICAL_ASSISTANT").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MEDICAL_LAB_TECHNICIAN").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MEDICAL_RECORDS_TECHNICIAN").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("MIDDLE_SCHOOL_TEACHER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("NETWORK_ADMINISTRATOR").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("NURSE").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("OCCUPATIONAL_THERAPIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("OPERATIONS_MANAGER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("PHYSICAL_THERAPIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("PHYSICIAN_ASSISTANT").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("POLICE_OFFICER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("PROJECT_MANAGER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("PUBLIC_RELATIONS_SPECIALIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("RADIOLOGIC_TECHNOLOGIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("REAL_ESTATE_AGENT").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("REGISTERED_NURSE").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("RESEARCH_SCIENTIST").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("SALES_MANAGER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("SOCIAL_WORKER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("SOFTWARE_DEVELOPER").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("SOFTWARE_ENGINEER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("TECHNICAL_DIRECTOR").build());
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("TECHNICAL_WRITER").build());
        ...
        definitionService.save(Definition.builder().status(EStatus.ACTIVE).definitionType(EDefinitionType.POSITION).name("WEB_DEVELOPER").build());
    }
}
